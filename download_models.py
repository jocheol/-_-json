...
MODELS = [
    ...
    # ── 샌드위치 V2 (ReActor) 추가 모델 (2026-07-10) ──
    ...
    ('models/facerestore_models/GPEN-BFR-512.onnx',
     '/comfyui/models/facerestore_models/GPEN-BFR-512.onnx'),
    ('models/insightface/models/buffalo_l/1k3d68.onnx',
     '/comfyui/models/insightface/models/buffalo_l/1k3d68.onnx'),
    ('models/insightface/models/buffalo_l/2d106det.onnx',
     '/comfyui/models/insightface/models/buffalo_l/2d106det.onnx'),
    ('models/insightface/models/buffalo_l/det_10g.onnx',
     '/comfyui/models/insightface/models/buffalo_l/det_10g.onnx'),
    ('models/insightface/models/buffalo_l/genderage.onnx',
     '/comfyui/models/insightface/models/buffalo_l/genderage.onnx'),
    ('models/insightface/models/buffalo_l/w600k_r50.onnx',
     '/comfyui/models/insightface/models/buffalo_l/w600k_r50.onnx'),
    ('models/facedetection/detection_Resnet50_Final.pth',
     '/comfyui/models/facedetection/detection_Resnet50_Final.pth'),
    ('models/nsfw_detector/vit-base-nsfw-detector/config.json',
     '/comfyui/models/nsfw_detector/vit-base-nsfw-detector/config.json'),
    ('models/nsfw_detector/vit-base-nsfw-detector/model.safetensors',
     '/comfyui/models/nsfw_detector/vit-base-nsfw-detector/model.safetensors'),
    ('models/nsfw_detector/vit-base-nsfw-detector/preprocessor_config.json',
     '/comfyui/models/nsfw_detector/vit-base-nsfw-detector/preprocessor_config.json'),
